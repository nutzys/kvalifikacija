        ...
        <div class="w-full h-20 bg-gradient-to-b from-black">
            <nav class="w-full h-full flex justify-between p-6">
                ...
                <div class="flex space-x-6 items-center">
                    ...
                    @if (!empty($user))
                        @if($user->is_admin == 1)
                            <a href="/admin" class="flex space-x-2 items-center justify-center text-white text-lg font-normal border-2 border-yellow-700 rounded-full w-fit h-fit py-2 px-4 hover:bg-yellow-700 hover:text-black hover:transition ease-in duration-200">Panelis</a>
                        @endif    
                    @endif
                </div>
            </nav>
        ...
        <div class="w-full h-52 border-[1px] border-black p-4 flex my-4">
            ...
            <div class="w-3/4 h-full p-2">
                ...
                <div class="w-full h-1/4 flex justify-evenly">
                    ...
                    <h1 class="flex space-x-2 items-center"><svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg><span class="text-gray-500">{{ $post->view_count }}</span></h1>
